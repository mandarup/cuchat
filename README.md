...
## Development environment and release process
 ...
 - create virtualenv with Flask and blackchat installed into it (latter is installed in
...
install it (`pip install blackchat.tar.gz`), ensure that configuration file exists and
`BLACKCHAT_SETTINGS` environment variable points to it, ensure that user has access to the
